...
# the triggers helps us to track changes to the docker file and rebuild the image
...
#command can be executed on a virtual machine
...
#Wait for the image to be uploaded , before the lambda config runs 
