...
#provider block - helps install plugins from library

provider "aws" {
    region = var.aws_region
    }

#next block aws plugin to get the id of an aws account
...
# referencing the kinesis module just created 
#creating the producer kinesis stream 
#ride_events
...
#creating the consumer kinesis stream 
#ride predictions 
